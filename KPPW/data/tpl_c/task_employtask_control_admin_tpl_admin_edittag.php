<?php Template_Class::subtplcheck('task/employtask/control/admin/tpl/admin_edittag', '1303866364', 'task/employtask/control/admin/tpl/admin_edittag');?><form method="post" action="index.php?do=tpl&view=edit_tag&rdo_tag_type=1&rdo_task_type=<?=$model['model_id']?>&tagid=<?=$tagid?>">
<dl><dt>标签模式：</dt><dd>
<?=$model['model_name']?>标签
</dd></dl>
<dl><dt>标签名：</dt><dd>
...
<dl><dt>推广：</dt><dd>
<input type="text" size="3" name="txt_prom_cash1" value="<?=$taginfo['prom_cash1']?>">元 以上
<input type="text" size="3" name="txt_prom_cash2" value="<?=$taginfo['prom_cash2']?>">元 以下
</dd></dl>
<dl><dt>发布者：</dt><dd>
