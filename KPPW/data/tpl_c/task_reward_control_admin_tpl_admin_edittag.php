<?php Template_Class::subtplcheck('task/reward/control/admin/tpl/admin_edittag', '1303866364', 'task/reward/control/admin/tpl/admin_edittag');?><form method="post" action="index.php?do=tpl&view=edit_tag&rdo_tag_type=1&rdo_task_type=<?=$model['model_id']?>&tagid=<?=$tagid?>">
<dl><dt>标签模式：</dt><dd>
<?=$model['model_name']?>标签
</dd></dl>
<dl><dt>标签名：</dt><dd>
