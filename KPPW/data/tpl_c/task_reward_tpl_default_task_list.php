<?php Template_Class::subtplcheck('task/reward/tpl/default/task_list', '1303805583', 'task/reward/tpl/default/task_list');?><?php $page_title=$indus_info['indus_name'].'悬赏任务列表 - '.$_K['html_title'] ?><?php if($inajax) { ?>
<?php ob_end_clean();
ob_start();
@header("Expires: -1");
...
<?php if($slt_order=='2') { ?>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($page_size) { ?>&page_size=<?=$page_size?><?php } ?>&slt_order=1">悬赏价格↓</a>
<?php } else { ?>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($page_size) { ?>&page_size=<?=$page_size?><?php } ?>&slt_order=2">悬赏价格↑</a>
<?php } ?>

<?php if($slt_order=='4') { ?>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($page_size) { ?>&page_size=<?=$page_size?><?php } ?>&slt_order=3">剩余时间↓</a> 
<?php } else { ?>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($page_size) { ?>&page_size=<?=$page_size?><?php } ?>&slt_order=4">剩余时间↑</a>
<?php } ?>
...
悬赏金额：
 ...
 <option value=''>请选择金额范围</option>
 	<?php if(is_array($reward_cove_arr)) { foreach($reward_cove_arr as $key => $value) { ?>
<option value="<?=$key?>" <?php if($slt_cash_cove==$key) { ?>selected<?php } ?>><?=$value?></option>
<?php } } ?>
 </select>
 条数:
 <a href="index.php?do=task_list&model_id=<?=$model_id?>&page_size=20&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?>">20</a>
 <a href="index.php?do=task_list&model_id=<?=$model_id?>&page_size=40&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?>">40</a>
 <a href="index.php?do=task_list&model_id=<?=$model_id?>&page_size=80&view=<?=$view?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?><?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?>">80</a></div>
                <dl><dd class="post_task_tab_dt">
                	<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=all<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='all' or $view=='' ) { ?>class="post_task_tab_now"<?php } ?>>所有任务</h3></a>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=proceed<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='proceed') { ?>class="post_task_tab_now"<?php } ?>>正在进行</h3></a>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=sp<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='sp') { ?>class="post_task_tab_now"<?php } ?>>公示任务</h3></a>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=vote<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='vote') { ?>class="post_task_tab_now"<?php } ?>>投票任务</h3></a>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=over<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='over') { ?>class="post_task_tab_now"<?php } ?>>已结束</h3></a>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=vip<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='vip') { ?>class="post_task_tab_now"<?php } ?>>VIP任务</h3></a>
<a href="index.php?do=task_list&model_id=<?=$model_id?>&view=commend<?php if($slt_order) { ?>&slt_order=<?=$slt_order?><?php } ?><?php if($slt_cash_cove) { ?>&slt_cash_cove=<?=$slt_cash_cove?><?php } ?>"><h3 <?php if($view=='commend') { ?>class="post_task_tab_now"<?php } ?>>推荐任务</h3></a>
</dd>
...
任务已结束
<?php } elseif($value['task_status']==3) { ?>
公示中
<?php } else { ?>
...
<a <?php if($indus_id==$value['indus_id']) { ?>style="color: #fe8b2f"<?php } ?> href="index.php?do=task_list&model_id=<?=$model_id?>&indus_id=<?=$value['indus_id']?>"><?=$value['indus_name']?></a>
<?php } ?>
<?php } } ?>
<?php } } ?>  
            </dd></dl>
