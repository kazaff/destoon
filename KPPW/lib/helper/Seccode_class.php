...
$code->fontpath = S_ROOT . './resource/img/seccode/font/';
$code->datapath = S_ROOT . './resource/img/seccode/';
...
function make_seccode($hash=''){
	global $_K;
	$seccode = random(6, 1);
	$_SESSION['seccode'] = substr($seccode,0,4);
	return $seccode;
}
...
define ( 'CODETABLE_DIR', S_ROOT . './data/table/' );
...
class Chinese {
	...
	var $config = array ('SourceLang' => '', 'TargetLang' => '', 'GBtoUnicode_table' => 'gb-unicode.table', 'BIG5toUnicode_table' => 'big5-unicode.table', 'GBtoBIG5_table' => 'gb-big5.table' );
