...
/**
 * Project:     Secode_class: A PHP class for creating and managing form CAPTCHA images<br />
...
class Secode_class {
   ...
   * @var mixed
   */
  var $gd_font_file = 'resource/img/gdfonts/crass.gdf';
   ...
   * @var string
   */
  var $ttf_file = "resource/img/elephant.ttf";
   ...
   *
   * @see Secode_class::$use_multi_text
   * @var string
   */
   ...
   *
   * @see Secode_class::$multi_text_color
   * @var boolean
   */
   ...
   *
   * @see Secode_class::$text_transparency_percentage
   * @var boolean
   */
   ...
   *
   * @see Secode_class::$use_transparent_text
   * @var int
   */
   ...
   *
   * @see Secode_class::$line_color
   * @see Secode_class::$line_distance
   * @see Secode_class::$line_thickness
   * @see Secode_class::$draw_lines_over_text
   * @var boolean
   */
  var $draw_lines = true;
