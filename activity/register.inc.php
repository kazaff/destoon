...
if($_userid) dheader('http://www.google.com/');	//如果已经报名，则跳转到提交作品页面
...
if($submit) {
	...
	*/
	...
	include template('register', 'activity');
}
?>