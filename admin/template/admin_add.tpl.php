...
&nbsp;&nbsp;<a href="javascript:if($('username').value)_user($('username').value);" class="t" title="点击查看填写会员的详细资料">[资料]</a>
...
<tr>
<td class="tl">角色名称</td>
<td><input type="text" size="20" name="role" id="role"/> <span class="f_gray">可以为角色名称，例如编辑、美工等，也可以为该管理员的备注</span></td>
</tr>
</table>
