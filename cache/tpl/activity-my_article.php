<?php defined('IN_DESTOON') or exit('Access Denied');?><?php include template('header', 'activity');?>
...
<tr title="提示：多个关键词请用空格分隔" style="display:none">
...
<?php } ?>
<?php include template('footer', 'activity');?>