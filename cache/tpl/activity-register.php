...
<div class="m">
	...
	<div style="padding:20px 50px 20px 50px;">
		...
		<br/>
			...
			<?php if($k>6 && $v['vip']==0) { ?><input type="radio" name="post[regid]" value="<?php echo $k;?>" id="g_<?php echo $k;?>"onclick="reg(0);" checked="checked" /><label for="g_<?php echo $k;?>"> <?php echo $GROUP[$k]['groupname'];?></label>&nbsp;&nbsp;&nbsp;&nbsp;<?php } ?>
			<?php } } ?>
			</td>
			</tr>
			<table cellpadding="5" cellspacing="5" width="100%">
