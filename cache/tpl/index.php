...
<div class="m">
	...
	<div class="m_r f_l">
		...
		<div class="headline">
		<?php $test = tag("moduleid=21&condition=status=3 and level=5&order=addtime desc&pagesize=10&target=_blank&template=null")?>
                 <?php print_r($test)?>
		</div>
		<?php } ?>
		...
		<tr>
		<td valign="top" width="120" class="imb"><?php $test = tag("moduleid=21&length=16&condition=status=3 and level=3 and thumb<>''&pagesize=1&target=_blank&order=addtime desc&width=100&height=80&cols=1&template=null")?>
<?php print_r($test)?>
</td>
		<td valign="top"><?php $test = tag("moduleid=21&condition=status=3 and level=1&pagesize=5&order=addtime desc&target=_blank&template=null")?>
<?php print_r($test)?>
</td>
		</tr>
		</table>
		...
		<?php $test = tag("moduleid=21&condition=status=3&pagesize=".$DT['page_news']."&datetype=2&order=addtime desc&target=_blank&template=null")?>
<?php print_r($test)?>
</div>
		</div>
		<?php } ?>
...
<div class="tab_head">
		<ul>
			<li class="tab_2" id="weike_t_1" onmouseover="Tb(1, 2, 'weike', 'tab');"><a href="<?php echo $MODULE['9']['linkurl'];?>">最新招标任务</a></li>
			<li class="tab_1" id="weike_t_2" onmouseover="Tb(2, 2, 'weike', 'tab');"><a href="<?php echo $MODULE['9']['linkurl'];?>">最新推荐任务</a></li>
                        <li class="tab_1" id="weike_t_3" onmouseover="Tb(3, 2, 'weike', 'tab');"><a href="<?php echo $MODULE['9']['linkurl'];?>">最新悬赏任务</a></li>
		</ul>
		</div>
		<div class="box_body">
			<div id="weike_c_1" style="display:">
			
			</div>
			<div id="weike_c_2" style="display:none">
			
			</div>
                        <div id="weike_c_3" style="display:none">
