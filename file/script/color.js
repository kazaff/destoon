...
function color_close() {color_hide(); $('color_img_'+color_id).style.backgroundColor = color_bk;}
function color_select(color) {$('color_input_'+color_id).value = color; $('color_img_'+color_id).style.backgroundColor = color; color_hide();}
...
function color_view(color) {try {$('color_viewview').value = color; $('color_viewview').style.color = color; $('color_img_'+color_id).style.backgroundColor = color;} catch(e) {}}