...
<td id="name">我的面板</td>
<td width="45">
<a href="./" target="_blank"><img src="admin/image/home.gif" width="8" height="8" title="网站首页"/></a>&nbsp;
...
<div style="display:none;">
	...
	<?php
		...
		if(is_file($menuinc)) {
			...
			include $menuinc;
			echo '<dl id="dl_'.$moduleid.'">';
			echo '<dt id="dt_'.$moduleid.'" onclick="s(this);;h($(\'dt_pay\'));;h($(\'dt_oth\'));" onmouseover="this.className=\'dt_on\';" onmouseout="this.className=\'\';">'.$name.'管理</dt>';
			foreach($menu as $m) {
				echo '<dd onclick="c(this);" style="display:none;"><a href="'.$m[1].'">'.$m[0].'</a></dd>';
			}
			echo '</dl>';
	...
	?>
	<dl id="dl_pay"> 
	<dt id="dt_pay" onclick="s(this);h($('dt_oth'));h($('dt_4'));" onmouseover="this.className='dt_on';" onmouseout="this.className='';">财务管理</dt>
	<?php
	...
	<dl id="dl_oth"> 
	<dt id="dt_oth" onclick="s(this);h($('dt_pay'));h($('dt_4'));" onmouseover="this.className='dt_on';" onmouseout="this.className='';">会员相关</dt> 
	<?php
