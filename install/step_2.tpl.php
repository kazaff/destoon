...
<div>
	...
	<td>4.3.0及以上</td>
	<td>5.0.0及以上</td>
	<td><?php echo $php_pass ? '<span style="color:blue;">通过</span>' : '<span style="color:red;">PHP版本过低</span>';?></td>
	</tr>
	<tr bgcolor="#D4D0C8" align="center">
	<td>MySQL版本</td>
	...
	<td>4.0.0及以上</td>
	<td>5.0.0及以上</td>
	<td><?php echo $mysql_pass ? '<span style="color:blue;">通过</span>' : '<span style="color:red;">MySQL版本过低</span>';?></td>
	</tr>
	<tr bgcolor="#D4D0C8" align="center">
	<td>GD库</td>
	...
	<td>jpg gif png</td>
	<td>jpg gif png</td>
	<td><?php echo $gd_pass ? '<span style="color:blue;">通过</span>' : '<span style="color:red;">无法处理图片</span>';?></td>
	</tr>
	<tr bgcolor="#D4D0C8" align="center">
	<td>URL打开文件</td>
	...
	<td>支持</td>
	<td>支持</td>
	<td><?php echo $url_pass ? '<span style="color:blue;">通过</span>' : '<span style="color:red;">建议开启</span>';?></td>
	</tr>
	</table>
	<br/>
	<br/>
