...
$L['ajax_member_username'] = '会员名不能为空';
$L['ajax_member_email'] = '邮件格式不正确';
$L['ajax_member_email_exists'] = '邮件地址已经存在';
$L['ajax_member_company'] = '公司名称不能为空';
$L['ajax_member_company_exists'] = '公司名称已经存在';
/* common.inc.php */
