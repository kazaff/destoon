...
FCKConfig.ToolbarSets["Destoon"] = [
	['Source','-','PasteWord','PasteText','-','Bold','TextColor','FontSize','Link','Unlink','Image','Flash','Media','Rule','SpecialChar','JustifyLeft','JustifyCenter','JustifyRight','Attach','FitWindow']
];
} else {
FCKConfig.ToolbarSets["Destoon"] = [
	['PasteWord','PasteText','-','Bold','TextColor','FontSize','Link','Unlink','Image','Flash','Media','Rule','SpecialChar','JustifyLeft','JustifyCenter','JustifyRight','Attach','FitWindow']
];
}
if(IsAdmin) {
...
FCKConfig.ToolbarSets["Basic"] = [
	['Source','-','Bold','Italic','Underline','-','TextColor','FontSize','-','Link','Unlink','-','SpecialChar','JustifyLeft','JustifyCenter','JustifyRight','-','FitWindow']
];
} else {
FCKConfig.ToolbarSets["Basic"] = [
