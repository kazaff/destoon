...
<input type="submit" value=" 更新品牌 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';" title="更新该模块所有品牌地址等项目"/>
</td>
</tr>
</table>
</form>
