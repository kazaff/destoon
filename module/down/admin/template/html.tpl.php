...
<input type="submit" value=" 更新下载 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';" title="更新该模块所有下载地址等项目"/>
</td>
</tr>
</table>
</form>
...
<input type="submit" value=" 更新下载 " class="btn" onclick="this.form.action='?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=show&update=1';"/>
</td>
</tr>
</table>
</form>
