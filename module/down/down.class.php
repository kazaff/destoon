...
class down {
    ...
    function down($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','level','title','style','fee','introduce','tag','thumb','fileurl','fileext','filesize','unit','status','hits','download','username','addtime','editor','edittime','ip','template', 'linkurl','filepath','note');
    }
