...
<td><a href="<?php echo $MOD['linkurl'].$CATEGORY[$v['catid']]['linkurl'];?>" target="_blank"><?php echo $CATEGORY[$v['catid']]['catname'];?></a></td><td><?php if($v['level']) {?><a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=<?php echo $action;?>&level=<?php echo $v['level'];?>"><img src="admin/image/level_<?php echo $v['level'];?>.gif" title="<?php echo $v['level'];?>级" alt=""/></a><?php } ?></td>
...
<td><a href="?moduleid=<?php echo $moduleid;?>&file=<?php echo $file;?>&action=<?php echo $action;?>&process=<?php echo $v['process'];?>"><img src="<?php echo DT_SKIN;?>image/exh_p<?php echo $v['process'];?>.gif" title="<?php echo $v['city'];?> <?php echo $v['fromdate'].'~'.$v['todate'];?>" alt=""/></a></td>
<td>
<?php if($v['username']) { ?>
