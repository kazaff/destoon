...
class exhibit {
    ...
    function exhibit($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','level','title','style','fee','fromtime','totime','city','address','hallname','remark','thumb','sponsor','undertaker','truename','addr','telephone','mobile','fax','email','msn','qq','status','hits','username','addtime','editor','edittime','ip','template','linkurl','filepath','note');
    }
