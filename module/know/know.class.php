...
class know {
    ...
    function know($moduleid) {
		...
		$this->db = &$db;
		$this->fields = array('catid','level','title','style','fee','credit','process','hidden','introduce','addition','thumb','tag','status','hits','username','addtime','totime','editor','edittime','ip','template', 'linkurl','filepath','note');
    }
