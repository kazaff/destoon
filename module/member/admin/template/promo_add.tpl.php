...
<tr>
<td class="tl">优惠用途 <span class="f_red">*</span></td>
<td>
<input type="radio" name="type" value="0" id="t_0" onclick="$('am').innerHTML='<?php echo $DT['money_unit'];?>';" checked/><label for="t_0"> 抵金额</label>&nbsp;&nbsp;
...
<tr>
<td class="tl">重复使用 <span class="f_red">*</span></td>
