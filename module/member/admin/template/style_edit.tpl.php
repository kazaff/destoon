...
<td><input name="post[skin]" id="skin" type="text" size="30" value="<?php echo $skin;?>" /><?php tips('请上传目录至 ./'.$MODULE[4]['moduledir'].'/skin/ 名称为数字、字母组合');?> <span id="dskin" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">模板目录 <span class="f_red">*</span></td>
<td><input name="post[template]" id="template" type="text" size="30" value="<?php echo $template;?>" /><?php tips('请上传目录至 ./template/'.$CFG['template'].'/ 名称为数字、字母组合');?> <span id="dtemplate" class="f_red"></span></td>
</tr>
<tr>
<td class="tl">模板作者</td>
