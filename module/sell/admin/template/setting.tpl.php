...
<input type="radio" name="setting[group]" value=""  <?php if($group == '') echo 'checked';?>/> 关闭
<?php tips('开启此项可以在列表时一个公司仅显示一条信息<br/>开启按公司将导致游客信息无法显示<br/>开启按IP会略微增加服务器负载');?>
</td>
</tr>
<tr>
