...
<td>
<a href="?moduleid=<?php echo $moduleid;?>&file=item&action=add&specialid=<?php echo $v['itemid'];?>"><img src="admin/image/new.png" width="16" height="16" title="向此专题位添加信息" alt=""/></a>&nbsp;
