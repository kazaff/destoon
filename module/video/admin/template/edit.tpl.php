...
<td><?php echo $_admin == 1 ? category_select('post[catid]', '选择分类', $catid, $moduleid) : ajax_category_select('post[catid]', '', $catid, $moduleid);?> <span id="dcatid" class="f_red"></span></td>
</tr>
<tr>
...
<tr>
<td class="tl">标题图片 <span class="f_red">*</span></td>
<td><input name="post[thumb]" id="thumb" type="text" size="60" value="<?php echo $thumb;?>"/>&nbsp;&nbsp;<span onclick="Dthumb(<?php echo $moduleid;?>,<?php echo $MOD['thumb_width'];?>,<?php echo $MOD['thumb_height'];?>, $('thumb').value);" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="_preview($('thumb').value);" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="$('thumb').value='';" class="jt">[删除]</span><span id="dthumb" class="f_red"></span></td>
</tr>

<tr>
<td class="tl">视频地址 <span class="f_red">*</span></td>
<td><input name="post[video]" id="video" type="text" size="60" value="<?php echo $video;?>"/>&nbsp;&nbsp;<span onclick="Dfile(<?php echo $moduleid;?>, $('video').value, 'video', '<?php echo $MOD['upload'];?>');" class="jt">[上传]</span>&nbsp;&nbsp;<span onclick="vs();" class="jt">[预览]</span>&nbsp;&nbsp;<span onclick="$('video').value='';" class="jt">[删除]</span> <span id="dvideo" class="f_red"></span>
<div id="v_player"></div>
<?php load('page.js');?>
...
function vs() {
	if($('video').value.length > 5) {
		...
		Ds('v_player');
		Inner('v_player', player($('video').value,$('width').value,$('height').value,p,1)+'<br/><a href="javascript:" onclick="vh();" class="t">[关闭预览]</a>');
	} else {
		vh();
	}
}
...
<tr>
<td class="tl">视频宽度 <span class="f_red">*</span></td>
...
<tr>
<td class="tl">播放器 <span class="f_red">*</span></td>
<td>
<?php
